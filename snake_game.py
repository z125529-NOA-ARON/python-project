...
class SnakeGame:
    """
    SnakeGame: Eunice - z125470
    handling the Snake game logic
    Manages the game loop, snake movement, collisions, score handling, and rendering using pygame
    Interacts with ScoreManager to save scores and displays the game over screen when the player loses
    """
    ...
    def start(self):
        ...
        while True:
            ...
            for block in self.snake:
                pygame.draw.rect(screen, personalisation.snake_color, (*block, self.block, self.block),border_radius =  30)
